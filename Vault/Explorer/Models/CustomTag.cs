...
namespace Microsoft.Vault.Explorer
{
    ...
    public class CustomTag
    {
        ...
        [JsonProperty]
        public Dictionary<string,List<TagValues>> ValueList { get; } = new Dictionary<string, List<TagValues>>();

        [JsonProperty]
        public List<TagValues> CustomTagValueList { get; } = new List<TagValues>();
