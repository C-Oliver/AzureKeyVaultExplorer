...
namespace Microsoft.Vault.Explorer
{
    ...
    {
        private static Settings defaultInstance = InitializeSettings();
        ...
        private static Settings InitializeSettings()
        {
            ...
            {
                // User config is corrupt (e.g., from a previous version) — delete it and retry
                ...
                if (System.IO.File.Exists(userConfigPath))
                    System.IO.File.Delete(userConfigPath);
                return (Settings)ApplicationSettingsBase.Synchronized(new Settings());
            }
        }
