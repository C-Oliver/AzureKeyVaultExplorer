...
namespace Microsoft.Vault.Explorer
{
    public partial class SecretDialog : ItemDialogBase<PropertyObjectSecret, KeyVaultSecret>
    {
        ...
        private static bool IsPrivateKeyExportable(X509Certificate2 certificate)
        {
            try
            {
        ...
        {
            bool hasExportablePrivateKey = certificate.HasPrivateKey && IsPrivateKeyExportable(certificate);
